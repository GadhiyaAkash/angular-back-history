 ...
 * @name Gadhiya_Akash
 * @description
 * A history service for AngularJS.  Undo/redo, that sort of thing.  
 * Has nothing to do with the "back" button, unless you want it to.
 *
 */
(function () {
  'use strict';
  ...
  /**
   * @ngdoc service
   * @name angular-back-history.service:History
   * @description
   * Provides an API for keeping a history of model values.
   */
  angular.module('angular-back-history', ['lazyBind']).service('History',
    [
      '$parse',
      '$rootScope',
      '$interpolate',
    ...
    function ($parse, $rootScope, $interpolate, $lazyBind, $timeout, $log,
      ...
      // TODO: async safe?
        ...
        deepWatchId = 0; // incrementing ID of deep {@link angular-back-history.object:Watch Watch instance}s

      /**
       * @ngdoc object
       * @name angular-back-history.object:Watch
       * @overview
       * @constructor
       * @description
       ...
       *
       * See the docs for {@link angular-back-history.service:History#deepWatch History.deepWatch()} for an example of using these functions.
       *
       ...
       * @private
       * @returns {Watch} This {@link angular-back-history.object:Watch Watch instance}
       */
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#addChangeHandler
       * @methodOf angular-back-history.object:Watch
       * @method
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#addUndoHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Unique name of handler
       * @param {Function} fn Function to execute upon change
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#addRedoHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Unique name of handler
       * @param {Function} fn Function to execute upon change
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#addRevertHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Unique name of handler
       * @param {Function} fn Function to execute upon change
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#addRollbackHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Unique name of handler
       * @param {Function} fn Function to execute upon change
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#removeRevertHandler
       * @methodOf angular-back-history.object:Watch
       * @method
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#removeChangeHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Name of handler to remove
       * @returns {Watch} This {@link angular-back-history.object:Watch Watch instance}
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#removeUndoHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Name of handler to remove
       * @returns {Watch} This {@link angular-back-history.object:Watch Watch instance}
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#removeRollbackHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Name of handler to remove
       * @returns {Watch} This {@link angular-back-history.object:Watch Watch instance}
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.object:Watch#removeRedoHandler
       * @methodOf angular-back-history.object:Watch
       * @method
       * @param {string} name Name of handler to remove
       * @returns {Watch} This {@link angular-back-history.object:Watch Watch instance}
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#watch
       * @method
       * @methodOf angular-back-history.service:History
       * @description
       ...
       * @returns {Watch|Array} {@link angular-back-history.object:Watch Watch instance} or array of them
       *
       * @example
       * <example module="angular-back-history">
       <file name="script.js">

       angular.module('angular-back-history')
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#deepWatch
       * @method
       * @methodOf angular-back-history.service:History
       * @description
       ...
       * @param {Object=} lazyOptions Options for lazy loading.  Only valid
       * property is `timeout` at this point
       * @return {Watch} {@link angular-back-history.object:Watch Watch instance}
       */
      this.deepWatch =
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#forget
       * @method
       * @methodOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#undo
       * @method
       * @methodOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#redo
       * @method
       * @methodOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#canUndo
       * @method
       * @methodOf angular-back-history.service:History
       * @description
       ...
       * <example module="angular-back-history">
       <file name="script.js">
       angular.module('angular-back-history').run(function(History, $rootScope) {
              $rootScope.foo = 'bar';
              History.watch('foo');
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#canRedo
       * @method
       * @methodOf angular-back-history.service:History
       * @description
       ...
       * @method
       * @methodOf angular-back-history.service:History
       * @name angular-back-history.service:History#revert
       * @description
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#batch
       * @method
       * @methodOf angular-back-history.service:History
       * @description
       ...
       * @param {Scope=} scope Scope object; defaults to `$rootScope`
       * @param {string=} description Description of this change
       * @returns {Watch} {@link angular-back-history.object:Watch Watch instance}
       * @example
       <example module="angular-back-history">
       <file name="script.js">
       angular.module('angular-back-history').run(function(History, $rootScope) {
      ...
      /**
       * @ngdoc function
       * @name angular-back-history.service:History#rollback
       * @method
       * @methodOf angular-back-history.service:History
       * @description
       * Rolls a transaction back that was executed via {@link angular-back-history.service:History#batch batch()}.
       *
       * For an example, see {@link angular-back-history.service:History#batch batch()}.
      ...
      /**
       * @ngdoc property
       * @name angular-back-history.service:History#history
       * @propertyOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc property
       * @name angular-back-history.service:History#descriptions
       * @propertyOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc property
       * @name angular-back-history.service:History#pointers
       * @propertyOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc property
       * @name angular-back-history.service:History#watches
       * @propertyOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc property
       * @name angular-back-history.service:History#lazyWatches
       * @propertyOf angular-back-history.service:History
       * @description
      ...
      /**
       * @ngdoc property
       * @name angular-back-history.service:History#watchObjs
       * @propertyOf angular-back-history.service:History
       * @description
       * The complete index of all {@link angular-back-history.object:Watch Watch} objects registered, keyed by Scope `$id` and then (optionally) expression.
       * @type {{}}
       */
